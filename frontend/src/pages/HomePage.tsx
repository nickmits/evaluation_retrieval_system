...
import type { SystemSelection, EmbeddingConfig, RetrievalConfig, EnsembleWeights } from '@/types/evaluation.types'
...
const HomePage: React.FC = () => {
  ...
  // Inject advanced configs into selected systems
  const getSystemsWithAdvancedConfig = () => {
      ...
      >
        ...
        <TabPanel value={activeTab} index={0}>
          ...
          <AdvancedConfig
            ...
            onEmbeddingChange={setEmbeddingConfig}
            onRetrievalChange={setRetrievalConfig}
            onWeightsChange={setEnsembleWeights}
          />
          ...
          {currentDocument && selectedSystems.length > 0 && (
            <Box>
              ...
              <EvaluationRunner
                ...
                selectedSystems={getSystemsWithAdvancedConfig()}
