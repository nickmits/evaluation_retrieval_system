...
async def metrics_analyzer_agent(
    ...
    structured_model = model.with_structured_output(MetricsAnalysis, method="function_calling")
...
async def performance_analyzer_agent(
    ...
    structured_model = model.with_structured_output(PerformanceInsights, method="function_calling")
...
async def recommendation_agent(
    ...
    structured_model = model.with_structured_output(Recommendations, method="function_calling")
...
async def report_generator_agent(
    ...
    structured_model = model.with_structured_output(FinalReport, method="function_calling")
